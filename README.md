...
* [Agent-Hypervisor: Runtime Supervisor for Multi-Agent Systems with Execution Rings, Saga Orchestration, and Circuit Breakers](https://github.com/microsoft/agent-governance-toolkit) - Provides fault tolerance patterns (circuit breakers, saga compensation, ring-based isolation) for AI agent systems at scale
* [Agent-SRE: AI-Native Site Reliability Engineering Framework with SLOs, Chaos Testing, and Canary Deployments](https://github.com/microsoft/agent-governance-toolkit) - SRE discipline for AI agent systems including error budgets, automated incident response, and progressive rollouts
